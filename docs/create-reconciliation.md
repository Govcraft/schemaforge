...
A lost reservation response may be retried by reserving again: reservation never creates an entity, and orphan pending receipts expire. Once an intent is used for entity creation, preserve that identifier for recovery.
